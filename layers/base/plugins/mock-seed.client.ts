...
function seedPatientLeads() {
  ...
  const leads = [
    {
      // PL-1: Beratung steht an, war frisch ausgemacht
      id: 'pl-1',
      first_name: 'Maria',
      last_name: 'Schmidt',
      ...
      is_customer: false,
      last_status_change_at: iso(-60 * 12),
      lead_source: 'google',
    ...
    {
      // PL-2: HKP raus, kritische Phase — Tony's Beispiel
      id: 'pl-2',
      first_name: 'Thomas',
      last_name: 'Becker',
      ...
      missed_appointments: 0,
      is_customer: false,
      last_status_change_at: iso(-60 * 24 * 5),
      lead_source: 'facebook',
      follow_up: iso(-60 * 24),
      oportunity_value: 8500,
      Tags: ['hkp', 'follow-up', 'urgent'],
      date_created: iso(-60 * 24 * 14),
      date_updated: iso(-60 * 24 * 5),
      message: 'Mehrere Zahnlücken, brauche Beratung.',
    },
    {
      // PL-3: Anruf-Versuche laufen, einmal No-Show vorher
      id: 'pl-3',
      first_name: 'Anna',
      last_name: 'Wolf',
      ...
      is_customer: false,
      last_status_change_at: iso(-60 * 24 * 4),
      lead_source: 'instagram',
      follow_up: iso(60 * 24),
      oportunity_value: 2800,
      Tags: ['kontaktiert', 'no-show'],
      date_created: iso(-60 * 24 * 7),
      date_updated: iso(-60 * 24 * 2),
    },
    {
      // PL-4: Frisch eingegangen — Speed-to-Lead
      id: 'pl-4',
      first_name: 'Lisa',
      last_name: 'Wagner',
      ...
      missed_appointments: 0,
      is_customer: false,
      last_status_change_at: iso(-60 * 1),
      lead_source: 'tiktok',
    ...
    {
      // PL-5: HKP unterschrieben, Behandlungstermin gebucht
      id: 'pl-5',
      first_name: 'Michael',
      last_name: 'Roth',
      ...
      missed_appointments: 0,
      is_customer: false,
      last_status_change_at: iso(-60 * 24 * 2),
      lead_source: 'referral',
      follow_up: iso(60 * 24 * 5),
      oportunity_value: 6500,
      Tags: ['empfehlung', 'hkp-signed'],
      date_created: iso(-60 * 24 * 21),
      date_updated: iso(-60 * 24 * 2),
    },
  ]
